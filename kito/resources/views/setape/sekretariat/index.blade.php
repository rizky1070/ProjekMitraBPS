                ...
                <div class="bg-white p-4 rounded shadow">
                    ...
                    @else
                        ...
                        @foreach ($ketuas as $ketua)
                            <div class="flex items-center justify-between border-2 border-gray-400 rounded-full px-2 py-1 transition-all duration-200 hover:shadow-lg hover:border-blue-500 bg-white"> 
